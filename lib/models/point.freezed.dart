...
abstract class $PointCopyWith<$Res> {
  ...
  $Res call({int usedPoint, int point, String name});
}
...
class _$_Point implements _Point {
  const _$_Point({this.usedPoint = 0, this.point = 0, this.name = ''});
  ...
  @override
  String toString() {
    return 'Point(usedPoint: $usedPoint, point: $point, name: $name)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_Point &&
            const DeepCollectionEquality().equals(other.usedPoint, usedPoint) &&
...
abstract class _Point implements Point {
  const factory _Point(
      {final int usedPoint, final int point, final String name}) = _$_Point;
